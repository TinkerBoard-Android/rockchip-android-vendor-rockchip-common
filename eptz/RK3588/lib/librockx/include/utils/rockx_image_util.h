 ...
 * @return @ref rockx_ret_t 
 */
rockx_ret_t rockx_image_convert_with_crop(rockx_image_t *src_img, rockx_rect_t *src_roi, rockx_image_t *dst_img, rockx_rect_t *dst_roi, rockx_image_transform_mode trans_mode);
