...
USE_322x_PLUGIN := false
ifneq ($(filter rk322x rk3128h rk3328, $(strip $(TARGET_BOARD_PLATFORM))), )
	USE_322x_PLUGIN := true
else ifneq ($(strip $(TARGET_BOARD_PLATFORM),box)$(filter rk3368, $(strip $(TARGET_BOARD_PLATFORM))),)
	USE_322x_PLUGIN := true
endif

ifeq ($(USE_322x_PLUGIN), true)
include $(CLEAR_VARS)
...
ifeq ($(strip $(TARGET_BOARD_PLATFORM_PRODUCT)), box)
ifneq ($(strip $(TARGET_2ND_ARCH)), ))
LOCAL_SRC_FILES_$(TARGET_ARCH) := lib/$(TARGET_ARCH)/rk3368/box/$(LOCAL_MODULE)$(LOCAL_MODULE_SUFFIX)
LOCAL_SRC_FILES_$(TARGET_2ND_ARCH) := lib/$(TARGET_2ND_ARCH)/rk3368/box/$(LOCAL_MODULE)$(LOCAL_MODULE_SUFFIX)
else
