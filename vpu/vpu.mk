...
PRODUCT_COPY_FILES += \
    ...
    vendor/rockchip/common/vpu/etc/etc2/media_codecs.xml:$(TARGET_COPY_OUT_OEM)/etc/media_codecs.xml \
    ...
    vendor/rockchip/common/vpu/etc/etc2/media_codecs_performance.xml:$(TARGET_COPY_OUT_OEM)/etc/media_codecs_performance.xml \
